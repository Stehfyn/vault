...
template <typename InitialEvent, typename OutputEvent, std::size_t... Is, typename Tuple>
constexpr auto generate_event_sequence_transitions(std::index_sequence<Is...>, const Tuple& guards);

template <typename InitialEvent, typename OutputEvent, typename TerminatingEvent, std::size_t... Is, typename Tuple>
...
constexpr auto generate_event_sequence_transitions(std::index_sequence<Is...>, const Tuple& guards) {
    ...
    return sml::make_transition_table(
        ...
        // Another event sequence may produce our bound OutputEvent, therefore reset the sequence if another sequence was identified first
